...
<div class="mypage-content">
    ...
    <div class="container">
        <div class="row text-center">
            <div class="no-selected col-md-4 pt-2 pb-2">
                <h3><a href="" class="link-font">出品中</a></h3>
            </div>
            <div class="no-selected col-md-4 pt-2 pb-2 m-0">
                <h3><a href="" class="link-font">取引中</a></h3>
            </div>
            <div class="col-md-4 pt-2 pb-2">
                <h3><a href="" class="link-font">売却済み</a></h3>
            </div>
        </div>
